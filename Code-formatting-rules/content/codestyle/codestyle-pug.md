...
* Между большими блоками кода следует оставлять одну пустую строку.
        ...
        Более подробный туториал можной найти здесь - https://gist.github.com/neretin-trike/53aff5afb76153f050c958b82abd9228
...
Если на странице используются какие-либо счетчики (Google Analytics, Яндекс Метрика и тому подобное), то этот также
...
Для комментариев используется синтаксис `//` и `//-`:
